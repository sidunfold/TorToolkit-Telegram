try:
    ...
    class ExecVars:
        ...
        API_HASH = "41be34a55a217c8a4315b158d284699d"
        API_ID = 7216115
        BOT_TOKEN = "1935638818:AAETMM9SYhJXHRlCD31j7Jn4XZpJ5c528D8"
        BASE_URL_OF_BOT = "http://35.247.145.167"

        # Edit the server port if you want to keep it default though.
        SERVPORT = 80

        # ALLOWED USERS [ids of user or supergroup] seperate by commas
        ALD_USR = [1001570582718]
        OWNER_ID = 1586637866
